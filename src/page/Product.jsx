  ...
  return (
    <div className="container mx-auto text-center">
      ...
      <input
        ...
        type="text"
        className="p-4 text-center text-sm text-gray-900 border border-gray-300 bg-gray-50 focus:ring-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500 my-10 rounded-lg py-1 px-4 focus:outline-none"
